...
/// groups are expanded by default.
 ...
 Map<String, int> get projectSessionDisplayLimits;/// Session IDs pinned by the user. Ordering is insertion order and is used
/// as the primary sort for both running and recent sessions.
 List<String> get pinnedSessionIds;/// Provider filter (All / Claude / Codex). Applied server-side.
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SessionListState&&const DeepCollectionEquality().equals(other.sessions, sessions)&&(identical(other.hasMore, hasMore) || other.hasMore == hasMore)&&(identical(other.isLoadingMore, isLoadingMore) || other.isLoadingMore == isLoadingMore)&&(identical(other.isInitialLoading, isInitialLoading) || other.isInitialLoading == isInitialLoading)&&(identical(other.searchQuery, searchQuery) || other.searchQuery == searchQuery)&&const DeepCollectionEquality().equals(other.accumulatedProjectPaths, accumulatedProjectPaths)&&const DeepCollectionEquality().equals(other.collapsedProjectPaths, collapsedProjectPaths)&&const DeepCollectionEquality().equals(other.loadingProjectPaths, loadingProjectPaths)&&const DeepCollectionEquality().equals(other.exhaustedProjectPaths, exhaustedProjectPaths)&&const DeepCollectionEquality().equals(other.projectSessionDisplayLimits, projectSessionDisplayLimits)&&const DeepCollectionEquality().equals(other.pinnedSessionIds, pinnedSessionIds)&&(identical(other.providerFilter, providerFilter) || other.providerFilter == providerFilter)&&(identical(other.namedOnly, namedOnly) || other.namedOnly == namedOnly));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(sessions),hasMore,isLoadingMore,isInitialLoading,searchQuery,const DeepCollectionEquality().hash(accumulatedProjectPaths),const DeepCollectionEquality().hash(collapsedProjectPaths),const DeepCollectionEquality().hash(loadingProjectPaths),const DeepCollectionEquality().hash(exhaustedProjectPaths),const DeepCollectionEquality().hash(projectSessionDisplayLimits),const DeepCollectionEquality().hash(pinnedSessionIds),providerFilter,namedOnly);

@override
String toString() {
  return 'SessionListState(sessions: $sessions, hasMore: $hasMore, isLoadingMore: $isLoadingMore, isInitialLoading: $isInitialLoading, searchQuery: $searchQuery, accumulatedProjectPaths: $accumulatedProjectPaths, collapsedProjectPaths: $collapsedProjectPaths, loadingProjectPaths: $loadingProjectPaths, exhaustedProjectPaths: $exhaustedProjectPaths, projectSessionDisplayLimits: $projectSessionDisplayLimits, pinnedSessionIds: $pinnedSessionIds, providerFilter: $providerFilter, namedOnly: $namedOnly)';
}
...
as Map<String, int>,pinnedSessionIds: null == pinnedSessionIds ? _self.pinnedSessionIds : pinnedSessionIds // ignore: cast_nullable_to_non_nullable
as List<String>,providerFilter: null == providerFilter ? _self.providerFilter : providerFilter // ignore: cast_nullable_to_non_nullable
...
/// as the primary sort for both running and recent sessions.
 final  List<String> _pinnedSessionIds;
/// Session IDs pinned by the user. Ordering is insertion order and is used
/// as the primary sort for both running and recent sessions.
@override@JsonKey() List<String> get pinnedSessionIds {
  if (_pinnedSessionIds is EqualUnmodifiableListView) return _pinnedSessionIds;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_pinnedSessionIds);
}
...
as Map<String, int>,pinnedSessionIds: null == pinnedSessionIds ? _self._pinnedSessionIds : pinnedSessionIds // ignore: cast_nullable_to_non_nullable
as List<String>,providerFilter: null == providerFilter ? _self.providerFilter : providerFilter // ignore: cast_nullable_to_non_nullable
as ProviderFilter,namedOnly: null == namedOnly ? _self.namedOnly : namedOnly // ignore: cast_nullable_to_non_nullable
as bool,
  ));
